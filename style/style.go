...
func headerGuideText(modifyDate string) string {
	...
	str += "<br><blockquote style='font-size: 13px; padding: 21px 25px !important' data-ke-style='style3'>" +
		...
		"   -따라서 너무 낮은 금액을 매수한 경우 평균단가가 주식가격과 비슷하게 나오지 않아요.<br>" +
		"3. 코스피-코스닥 순으로 나열해 되어있어요. <br>" +
		"4. 각 매수주체를 클릭하시면 내용이 변경되요 !<br> " +
		"5. 당일 거래종목수가 50종목이 안되는 경우도 있어요 ! " +
		"</blockquote>" +
		"<div style='text-align: center; color:#ff1d1d; font-size: 10px;'># 본 글은 광고를 포함하고 있어요. 광고 클릭에서 발생하는 수익금은 모두 블로그의 유지 및 관리, 그리고 콘텐츠 향상을 위해 쓰여집니다 !</div>"
	return str
}
